...
plot_dir = Path("/project/train/result-graphs/")
...
def parse_opt(known=False):
    ...
    parser.add_argument('--noval', default=True, help='only validate final epoch')
    ...
    parser.add_argument('--project', default=ROOT / '/project/train/models', help='save to project/name')
