...
def parse_args():
    ...
    parser.add_argument('--config', default="configs/cascade_rcnn/cascade_rcnn_r101_fpn_20e_smoke.py",help='train config file path')
...
#     mmcv.mkdir_or_exist(osp.abspath(cfg.work_dir))
    ...
    log_file = osp.join("../../log", f'{timestamp}.log')
